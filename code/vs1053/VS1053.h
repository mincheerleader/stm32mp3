...
#define VS_XDCS								GPIO_Pin_8								/*定义VS1053的片选管脚*/
#define VS_GPIO_XDCS_PORT			GPIOA											/* GPIO端口 */
#define VS_GPIO_XDCS_CLK			RCC_APB2Periph_GPIOA			/* GPIO端口时钟 */

#define VS_GPIO_RST_PORT			GPIOB											/* GPIO端口 */
#define VS_GPIO_RST_CLK				RCC_APB2Periph_GPIOB					/* GPIO端口时钟 */
#define VS_RST								GPIO_Pin_10								/*定义VS1053的RST管脚*/

#define VS_GPIO_DREQ_PORT			GPIOB											/* GPIO端口 */
#define VS_GPIO_DREQ_CLK			RCC_APB2Periph_GPIOB			/* GPIO端口时钟 */
#define VS_DREQ								GPIO_Pin_11								/*定义VS1053的DREQ管脚*/
